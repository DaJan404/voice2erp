...
class MessageEvent(MessageEvent_iface, _JsObject): # type:ignore[misc, unused-ignore]
    ...
    @classmethod
    @overload
    def new(self, type: str, /, *, bubbles: bool | None = None, cancelable: bool | None = None, composed: bool | None = None, data: Any | None = None, origin: str | None = None, lastEventId: str | None = None, source: MessagePort | None = None, ports: PyMutableSequence[MessagePort] | None = None) -> MessageEvent_iface: ... # type:ignore[misc,overload-overlap,override,unused-ignore]
...
class __BaseEnv_Env_iface(Protocol): # type:ignore[misc, unused-ignore]
    ...
    BC_TENANT_ID: str = ... # type:ignore[assignment,unused-ignore]
    BC_CLIENT_ID: str = ... # type:ignore[assignment,unused-ignore]
    BC_CLIENT_SECRET: str = ... # type:ignore[assignment,unused-ignore]
    BC_ENVIRONMENT: str = ... # type:ignore[assignment,unused-ignore]
    BC_COMPANY_ID: str = ... # type:ignore[assignment,unused-ignore]
